"""
    Note:   There was a bug somewhere here, so I decided to rewrite this file.
...
for sentence_index, (source_sentence_embeddings_matrix, target_sentence_embeddings_matrix, token_ids_target_sentence) in enumerate(TransformerDatasetInstance):
    ...
    # add the positional encoding to the current token embedding
    ...
    current_token_embedding = torch.add(current_token_embedding, positional_encoding_for_current_token_embedding)
