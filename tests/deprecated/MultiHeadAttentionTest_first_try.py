"""
    Note:   This code tests the MultiHeadAttention_first_try.py, which is deprecated and due to the deprecation this code isn't updated.
...
if __name__ == "__main__":
    ...
    MultiHeadAttention = MultiHeadAttention(h=h, d_k=d_k, d_v=d_v)
    ...
    print("MultiHeadAttention.forward(Q, K, V):")
    print(MultiHeadAttention.forward(Q, K, V))
    print("print(MultiHeadAttention.forward(Q, K, V)).shape:")
    print(MultiHeadAttention.forward(Q, K, V).shape)
