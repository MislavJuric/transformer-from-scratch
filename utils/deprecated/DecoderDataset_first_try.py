...
class DecoderDataset(torch.utils.data.Dataset):
    def __init__(self, path_to_target_language_txt_file, language="de", vocab_size=200000):
        self.path_to_target_language_txt_file = path_to_target_language_txt_file
        target_language_txt_file = open(self.path_to_target_language_txt_file, "r")
    ...
    def __len__(self):
        return len(self.all_lines_in_the_target_language_txt_file)

    def __getitem__(self, index):
        # get the embeddings
        requested_line = self.all_lines_in_the_target_language_txt_file[index]
    ...
    def return_bpemb_instance(self):
        return self.bpemb_instance

    def return_embedding_layer(self):
